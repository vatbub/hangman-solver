...
public class HangmanSolver {
     ...
     *
     * @param currentSequence The current letter sequence. The sequence must be something
     *                        like this: ___a__ where the underscores _ are the unknown
     *                        letters.
     * @param lang            The {@link Language} that the user is playing in.
     ...
     *
     * @param lang The {@link Language} to load.
     */
     ...
     *
     * @param wordsWithEqualLength The list for which the most frequent char will be determined.
     ...
     *
     * @param wordsWithEqualLength The list for which the most frequent char will be determined.
     * @param priorityChars        The ranking of most frequent chars will be filtered so that it
     ...
     * @param countList A List where each index represents the number of times this
     ...
     *
     * @param compareSequence The sequence to use to check if a letter is wrong or not.
     * @param word            The word to be checked.
     * @return {@code true} if the word contains a wrong char, {@code false}
     * otherwise.
     */
