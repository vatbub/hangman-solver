...
public class Language {
     ...
     */
    private static final Map<String, Locale> languageCodeMap = initLanguageCodeMap();
    /**
     ...
     *
     * @param languageCode The ISO 639-3 language code
     */
    ...
    public boolean equals(Object anObject) {
        return (anObject instanceof Language) && this.getLanguageCode().equals(((Language) anObject).getLanguageCode());
    }
     ...
     *
     * @throws IOException If the offline copy cannot be saved
     */
